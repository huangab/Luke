package com.hyp.flexbox_master.adapter;

import android.content.Context;
import android.support.v4.util.ArrayMap;
import android.widget.Toast;

import com.hyp.flexbox_master.widget.BaseTagView;
import com.hyp.flexbox_master.widget.TagFlowLayout;
...
public abstract class TagAdapter<V extends BaseTagView<T>, T> {
    ...
    /*标签选择操作的订阅接口*/
    private com.hyp.flexbox_master.interfaces.OnFlexboxSubscribeListener<T> onSubscribeListener;
    /*是否展示选中效果*/
    ...
    public void setOnSubscribeListener(com.hyp.flexbox_master.interfaces.OnFlexboxSubscribeListener<T> onSubscribeListener) {
    ...
    public void addTags() {
        ...
        for (T item : source) {
            ...
            // 单个item的点击监控
            view.setListener(new com.hyp.flexbox_master.interfaces.TagWithListener<T>() {
                @Override
