...
public class ResetPwdActivity extends AppCompatActivity {
    ...
    EditText mEtNewPwd;
    @BindView(R.id.et_reset_getcode)
    EditText mEtGetcode;
    @BindView(R.id.btn_reset_getcode)
    Button mBtnGetcode;
    @BindView(R.id.btn_reset)
    Button mBtnReset;
    private String phone,newPwd,objectId;
    ...
    @OnClick({R.id.btn_back, R.id.btn_reset_getcode, R.id.btn_reset})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btn_back:
                finish();
                break;
            case R.id.btn_reset_getcode:
                getCode();
                break;
            case R.id.btn_reset:
                CheckCode();
    ...
    private void CheckCode() {
        //获得用户输入的验证码
        String code = mEtGetcode.getText().toString().replaceAll("/s","");
        ...
        newUser.update(bmobUser.getObjectId(),new UpdateListener() {
            ...
            public void done(BmobException e) {
                if(e == null){
                    ...
                    ToastUtil.showShort(mContext,e.getErrorCode()+e.getMessage());
                }
            }
        });
    ...
    private void alterWarning() {
        ...
        Dialog_Show.showTwoButton(mContext, "提示", "我们将要发送到" + phone + "验证", "取消", "确定", result -> {
            if (result == "2") {
                ...
                //做倒计时操作
                ToastUtil.showShort(ResetPwdActivity.this, "已发送,请注意查收");
                ...
                dialog.dismiss();
                ToastUtil.showShort(ResetPwdActivity.this, "已取消");
            }
        });
