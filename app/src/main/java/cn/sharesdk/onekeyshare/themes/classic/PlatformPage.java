...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		///////////////增加分享到layout
		lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,80);
		lp.setMargins(0,0,0,0);
		LinearLayout buttonLayout = new LinearLayout(activity);
		buttonLayout.setBackgroundColor(Color.rgb(45,183,181));

		LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,80);
		...
		buttonLayout2.setBackgroundColor(Color.rgb(241,243,246));

		LinearLayout.LayoutParams lp22 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,140);
		lp22.setMargins(0, 10, 0, 0);//左上右下
		Button button2 = new Button(activity);
		button2.setText("取消");
		button2.setTextSize(16);
		button2.setTextColor(0xff646464);
